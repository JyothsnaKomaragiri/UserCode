...
###
### L1 and HLT Trigger information
process.load("L1TriggerConfig.L1GtConfigProducers.L1GtTriggerMaskTechTrigConfig_cff")
process.load("HLTrigger.HLTfilters.hltLevel1GTSeed_cfi")

process.hltLevel1GTSeed.L1TechTriggerSeeding = cms.bool(True)
## Old trigger selection
##process.hltLevel1GTSeed.L1SeedsLogicalExpression = cms.string("40 AND NOT (36 OR 37 OR 38 OR 39)")
## New trigger selection
## from http://cmssw.cvs.cern.ch/cgi-bin/cmssw.cgi/CMSSW/DPGAnalysis/Skims/python/MinBiasPDSkim_cfg.py?revision=1.15&view=markup
...
process.bTagValidation.jetMCSrc = ''
